...
CGLayerRef makeSampleLayer(CGContextRef ctx)
{
  ...
  CGContextMoveToPoint(layerCtx, 14, 35);
  CGContextAddArc(layerCtx, 10, 35, 4, 0, 2 * pi, 0);
  CGContextClosePath(layerCtx);
  CGContextMoveToPoint(layerCtx, 44, 35);
  CGContextAddArc(layerCtx, 40, 35, 4, 0, 2 * pi, 0);
  CGContextClosePath(layerCtx);
  CGContextMoveToPoint(layerCtx, 16, 15);
  CGContextAddArc(layerCtx, 12, 15, 4, 0, 2 * pi, 0);
  CGContextClosePath(layerCtx);
  CGContextMoveToPoint(layerCtx, 23, 10);
  CGContextAddArc(layerCtx, 19, 10, 4, 0, 2 * pi, 0);
  CGContextClosePath(layerCtx);
  CGContextMoveToPoint(layerCtx, 29, 8);
  CGContextAddArc(layerCtx, 25, 8, 4, 0, 2 * pi, 0);
  CGContextClosePath(layerCtx);
  CGContextMoveToPoint(layerCtx, 35, 10);
  CGContextAddArc(layerCtx, 31, 10, 4, 0, 2 * pi, 0);
  CGContextClosePath(layerCtx);
  CGContextMoveToPoint(layerCtx, 42, 15);
  CGContextAddArc(layerCtx, 38, 15, 4, 0, 2 * pi, 0);
  CGContextClosePath(layerCtx);
...
void draw(CGContextRef ctx, CGRect r)
{
  ...
  CGContextFillRect(ctx, CGRectMake(10,10,r.size.width - 20,
                                    r.size.height - 20));
  CGContextStrokeRect(ctx, CGRectMake(10,10,r.size.width - 20,
                                      r.size.height - 20));
