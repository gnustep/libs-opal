...
extern void frameArc(CGContextRef context, CGRect r, int startAngle,
                     int arcAngle);
extern void paintArc(CGContextRef context, CGRect r, int startAngle,
                     int arcAngle);
...
extern void strokeRoundedRect(CGContextRef context, CGRect rect,
                              CGFloat ovalWidth, CGFloat ovalHeight);

void drawRect(CGContextRef ctx, CGRect r)
{
  CGRect bounds = r;
  double a, b;
  int count, k;
  ...
  CGContextFillRect(ctx, CGRectMake(0, r.size.height / 2, r.size.width,
                                    r.size.height / 2));
  ...
  CGContextTranslateCTM(ctx, bounds.size.width/4 + bounds.size.width/2,
