...
const CFStringRef kOPPostScriptContextLanguageLevel =
  @"kOPPostScriptContextLanguageLevel";
...
static void  opal_setProperties(cairo_surface_t *surf,
                                CFDictionaryRef auxiliaryInfo)
{
  ...
  if ([[auxiliaryInfo valueForKey: kOPPostScriptContextLanguageLevel] intValue]
      == 2)
    {
