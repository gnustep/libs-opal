...
static inline CGFloat CGFloatFromFontUnits(NSInteger units, CGFloat pointSize,
    NSUInteger unitsPerEm)
{
  return (((CGFloat)units * pointSize) / (CGFloat)unitsPerEm);
}

static inline FT_Matrix FT_MatrixFromCGAffineTransform(CGAffineTransform
    transform)
{
 ...
 */
static inline FT_Vector FT_VectorQ1616FromCGAffineTransform(
